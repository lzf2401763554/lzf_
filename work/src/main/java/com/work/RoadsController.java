...
if (selectedFile.getName().contains(".xlsx"))writeListToExcel(roadsList,selectedFile);
     ...
     * @return 返回读入数据
     */
    public  List<Roads> readListFromFile1(File file) {
        ...
        List<Roads> list1 = new ArrayList<>();
        for (String s:list){
     ...
     * @param file 目标文件
     */
    public void writeListToFile2(List<Roads> list,File file) {
     ...
     * @return 返回读入数据
     */
    public List<Roads> readListFromFile2(File file) {
        List<Roads> list = null;
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file))) {
            list = (List<Roads>) ois.readObject();
     ...
     * @param file 目标文件
     */
    public  void writeListToExcel(List<Roads> dataList,File file) {
     ...
     * @return 返回读入数据
     */
    public  List<Roads> readListFromExcel(File file) {
    ...
    public  class ExcelDataListener extends AnalysisEventListener<Roads> {
        private List<Roads> dataList;

        public ExcelDataListener(List<Roads> dataList) {
            this.dataList = dataList;
        }


        @Override
        public void invoke(Roads data, AnalysisContext context) {
